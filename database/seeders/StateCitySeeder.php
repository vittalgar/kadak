...
class StateCitySeeder extends Seeder
{
    ...
    {
        // It's good practice to clear the tables before seeding to avoid duplicates
        ...
        foreach ($locations as $stateName => $cities) {
            ...
            // Prepare the city data with the state_id
            $cityData = [];
            foreach ($cities as $cityName) {
                $cityData[] = ['state_id' => $state->id, 'name' => $cityName, 'created_at' => now(), 'updated_at' => now()];
            }

            // Insert all cities for the current state in a single query
